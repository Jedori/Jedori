...
namespace HurricaneVR.Framework.Core
{
    public class HVRGrabbable : MonoBehaviour
    {
        ...
        public HVRDistanceGrabEvent DistanceGrabbed = new HVRDistanceGrabEvent();
        public HVRDistanceReleaseEvent DistanceReleased = new HVRDistanceReleaseEvent();
        ...
        public bool SwappingDistanceToHand { get; set; }
        ...
        protected virtual void OnGrabbed(HVRGrabberBase grabber)
        {
            ...
            //consider invoking events in each grabber class itself?
            ...
            if (grabber.IsSocket)
            {
                var hvrSocket = grabber as HVRSocket;
                IsSocketed = true;
                Socket = hvrSocket;
                Socketed.Invoke(hvrSocket, this);
            }
            else if (grabber.IsDistanceGrabber)
            {
                DistanceGrabbed.Invoke(new HVRDistanceGrabArgs(grabber as HVRForceGrabber, this));
            }
